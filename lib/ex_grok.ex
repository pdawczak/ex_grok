defmodule ExGrok do
  ...
  Once ngrok connection is succesfully esablised, the information about it can
  ...
  Currently, if `ex_grok` is enabled, starting ngrok is mandatory for starting
  whole application up, thus it doesn't provide facility reporting failed
  connection as this is never the case.
  """
